...
import ResetDetail from "./ResetDetail"
...
const WarehouseNavbar = () => {
  ...
  const navigation = [
    { name: "Resets", href: "/", icon: TemplateIcon, current: true },
    {
      name: "Shipping",
      href: "/shipping/list/",
      icon: TruckIcon,
      ...
      <div className="hidden lg:flex lg:flex-shrink-0">
        <div className="flex flex-col w-64">
          ...
          <div className="flex flex-col flex-grow bg-cyan-700 pt-5 pb-4">
            ...
            <nav className="mt-5 divide-y divide-cyan-100" aria-label="Sidebar">
              <div className="px-2 space-y-1">
                {navigation.map((item) => (
                  <Link
                    key={item.name}
        ...
        <main className="pb-8 z-0 ">
          <div className="">
            <Switch>
              ...
              <Route
                exact
                path={"/profile/:profileId/edit/:key"}
              ...
              <Route
                exact
                path={"/shipping/detail/resets/:resetNo"}
                component={ResetDetail}
              />
            </Switch>
          </div>
